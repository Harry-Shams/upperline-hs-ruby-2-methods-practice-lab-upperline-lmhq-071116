...
def map_size
  "The map is #{21 * 35} square inches"
end
...
def trip_length
	"This trip will take #{3 * 156} seconds"
end
...
def pay_dancers
  "the dancers made #{23 * 1.5} dollars"
end
...
def everything_is_awesome
  "Everything is awesome".times.times.times.times.times
end
